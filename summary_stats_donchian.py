...
# Cargar CSV
#df = pd.read_csv("outputs/tracking_record.csv", parse_dates=["entry_time", "exit_time"])
df = pd.read_csv("outputs/tracking_record_donchian_time_exit.csv", parse_dates=["entry_time", "exit_time"])
